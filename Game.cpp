...
void Game::CreateBasicGeometry()
{
	...
	D3D11_RASTERIZER_DESC wireframDesc = {};
	wireframDesc.FillMode = D3D11_FILL_WIREFRAME;
	wireframDesc.CullMode = D3D11_CULL_BACK;
	device->CreateRasterizerState(&wireframDesc, &wireFrame);
}
